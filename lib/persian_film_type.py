...
def prepare_film_type_props(props: dict[str, Any], composer: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="persian-film-type-") as temp:
        ...
        expected_version = {"2.1.0": 1, "2.2.0": 2, "2.3.0": 3, "2.4.0": 4, "2.5.0": 5, "2.6.0": 6, "2.7.0": 7, "2.8.0": 8, "2.9.0": 9, "2.10.0": 10, "2.11.0": 11, "2.12.0": 12, "2.13.0": 13, "2.14.0": 14, "2.15.0": 15}.get(design.get("profileVersion"))
